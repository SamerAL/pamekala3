...
GO
CREATE TRIGGER [Sales].[tr_i_AUDIT_Store]
ON [Sales].[Store]
FOR INSERT
...
-- Description:  INSERT TRIGGER for Table:  [Sales].[Store]
...
End
GO
EXEC sp_settriggerorder @triggername= '[Sales].[tr_i_AUDIT_Store]', @order='Last', @stmttype='INSERT'
GO
