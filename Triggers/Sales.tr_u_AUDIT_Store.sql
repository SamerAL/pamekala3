...
GO
CREATE TRIGGER [Sales].[tr_u_AUDIT_Store]
ON [Sales].[Store]
FOR UPDATE
...
-- Description:  UPDATE TRIGGER for Table:  [Sales].[Store]
...
End
GO
EXEC sp_settriggerorder @triggername= '[Sales].[tr_u_AUDIT_Store]', @order='Last', @stmttype='UPDATE'
GO
