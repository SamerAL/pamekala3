...
GO
CREATE TRIGGER [Production].[tr_d_AUDIT_ProductListPriceHistory]
...
-- Description:  DELETE TRIGGER for Table:  [Production].[ProductListPriceHistory]
...
END
GO
EXEC sp_settriggerorder @triggername= '[Production].[tr_d_AUDIT_ProductListPriceHistory]', @order='Last', @stmttype='DELETE'
GO
