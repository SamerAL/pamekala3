...
GO
CREATE TRIGGER [Person].[tr_d_AUDIT_BusinessEntity]
...
-- Description:  DELETE TRIGGER for Table:  [Person].[BusinessEntity]
...
END
GO
EXEC sp_settriggerorder @triggername= '[Person].[tr_d_AUDIT_BusinessEntity]', @order='Last', @stmttype='DELETE'
GO
