...
GO
CREATE TRIGGER [Production].[tr_d_AUDIT_TransactionHistory]
...
-- Description:  DELETE TRIGGER for Table:  [Production].[TransactionHistory]
...
END
GO
EXEC sp_settriggerorder @triggername= '[Production].[tr_d_AUDIT_TransactionHistory]', @order='Last', @stmttype='DELETE'
GO
