...
GO
CREATE TRIGGER [Person].[tr_u_AUDIT_BusinessEntity]
...
-- Description:  UPDATE TRIGGER for Table:  [Person].[BusinessEntity]
...
BEGIN
	...
	--Set @TABLE_NAME = '[Person].[BusinessEntity]'
...
End
GO
EXEC sp_settriggerorder @triggername= '[Person].[tr_u_AUDIT_BusinessEntity]', @order='Last', @stmttype='UPDATE'
GO
