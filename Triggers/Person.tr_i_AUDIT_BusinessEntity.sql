...
GO
CREATE TRIGGER [Person].[tr_i_AUDIT_BusinessEntity]
...
-- Description:  INSERT TRIGGER for Table:  [Person].[BusinessEntity]
...
End
GO
EXEC sp_settriggerorder @triggername= '[Person].[tr_i_AUDIT_BusinessEntity]', @order='Last', @stmttype='INSERT'
GO
