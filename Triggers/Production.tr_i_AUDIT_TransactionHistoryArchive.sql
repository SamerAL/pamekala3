...
GO
CREATE TRIGGER [Production].[tr_i_AUDIT_TransactionHistoryArchive]
...
-- Description:  INSERT TRIGGER for Table:  [Production].[TransactionHistoryArchive]
...
End
GO
EXEC sp_settriggerorder @triggername= '[Production].[tr_i_AUDIT_TransactionHistoryArchive]', @order='Last', @stmttype='INSERT'
GO
