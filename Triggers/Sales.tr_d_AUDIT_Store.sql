...
GO
CREATE TRIGGER [Sales].[tr_d_AUDIT_Store]
ON [Sales].[Store]
FOR DELETE
...
-- Description:  DELETE TRIGGER for Table:  [Sales].[Store]
...
END
GO
EXEC sp_settriggerorder @triggername= '[Sales].[tr_d_AUDIT_Store]', @order='Last', @stmttype='DELETE'
GO
